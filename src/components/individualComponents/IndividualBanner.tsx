...
const IndividualBanner = () => {
  return (
    <div className="flex flex-col md:flex-row h-[700px] ">
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center mt-32 md:mt-0 md:items-start xl:ml-48 md:ml-10 gap-5">
        ...
        <p className="text-gray-400 text-center md:text-left text-sm mx-2 sm:mx-0 md:text-base">
